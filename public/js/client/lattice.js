...
function getLine(pointX, pointY) {
  ...
  var lMesh = new THREE.Line(
    l,
    new THREE.LineBasicMaterial({ color: "red", linewidth: 3 })
  );
  return lMesh;
}
function Hexagonal(edgeLength, nodeRadius) {
  ...
  var shape = new THREE.Group();
  var points = [
    [-edgeLength / 1.5, +edgeLength, +edgeLength],
    [-edgeLength / 1.5, -edgeLength, +edgeLength],
    [+edgeLength / 1.5, +edgeLength, +edgeLength],
    [+edgeLength / 1.5, -edgeLength, +edgeLength],
    [-edgeLength / 1.5, +edgeLength, -edgeLength],
    ...
    [+edgeLength / 1.5, +edgeLength, -edgeLength],
    [+edgeLength / 1.5, -edgeLength, -edgeLength],
    [-edgeLength - edgeLength / 3, +edgeLength, 0],
    [-edgeLength - edgeLength / 3, -edgeLength, 0],
    [+edgeLength + edgeLength / 3, +edgeLength, 0],
    [+edgeLength + edgeLength / 3, -edgeLength, 0]
  ];
...
function Monoclinic(edgeLength, nodeRadius, param) {
  ...
  var shape = new THREE.Group();
  var points = [
    [+1.5 * edgeLength, +edgeLength, +edgeLength],
    [+edgeLength, -edgeLength, +edgeLength],
    [-0.5 * edgeLength, +edgeLength, +edgeLength],
    [-edgeLength, -edgeLength, +edgeLength],
    [+1.5 * edgeLength, +edgeLength, -edgeLength],
    [+edgeLength, -edgeLength, -edgeLength],
    [-0.5 * edgeLength, +edgeLength, -edgeLength],
...
function Orthorhombic(edgeLength, nodeRadius, param) {
  ...
  var points = [
    [-1.5 * edgeLength, -1.1 * edgeLength, +edgeLength],
    [+1.5 * edgeLength, -1.1 * edgeLength, +edgeLength],
    [+1.5 * edgeLength, +1.1 * edgeLength, +edgeLength],
    [-1.5 * edgeLength, +1.1 * edgeLength, +edgeLength],
    [-1.5 * edgeLength, -1.1 * edgeLength, -edgeLength],
...
function Triclinic(edgeLength, nodeRadius) {
  ...
  var shape = new THREE.Group();
  var points = [
    [+3.5 * edgeLength, +edgeLength, +edgeLength],
    [+1.5 * edgeLength, -edgeLength, +edgeLength],
    [1.5 * edgeLength, +edgeLength, +edgeLength],
    [-edgeLength, -edgeLength, +edgeLength],
    [+3.5 * edgeLength, +edgeLength, -edgeLength],
