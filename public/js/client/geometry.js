function Bond(r, h) {
  ...
  var cylinder = new THREE.Mesh(
    new THREE.CylinderGeometry(0.1, 0.1, h, 32),
    material
  );
...
function makeLonePair() {
  ...
  var lonepair = new THREE.Mesh(
    new THREE.SphereBufferGeometry(0.3, 32, 32),
    material1
  );
  group.add(lonepair);
  var dot1 = new THREE.Mesh(
...
function TrigonalBipyramidal(r, h, noOfLonePair) {
  ...
  group.add(l.shape);
  var points = [
    [sphere.position.x, sphere.position.y + 0.5, sphere.position.z],
    [sphere.position.x - 0.5, sphere.position.y - 0.2, sphere.position.z],
    [sphere.position.x + 0.5, sphere.position.y - 0.2, sphere.position.z]
  ];
  if (noOfLonePair == 0) {
